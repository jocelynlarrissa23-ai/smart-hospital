...
@st.cache_resource 
def load_model():
    width open('hospital_model.pkl', 'rb') as f: 
...
st.markdown("""
<div style="background: linear-gradient(135deg, #1e3a8a 0%, #1a56db 60%,#0ea5e9 100%); padding: 3rem 2rem 2.5rem;margin:-1rem 2 rem; text-align: center;"> 
    <div style="font-size: 14px; font-weight: 500; color: white; 
    text-transform: uppercase;letter-spacing: 0.1em; margin-bottom: 12px;">
        Future Classroom -Machine Learning
    </div>
    <div style="font-size: 36px; font-weight: 700; color: white; margin-bottom: 12px; letter-spacing: -0.02em;">
        Smart Hospital  Patient Navigator
    </div>
    <div style="font-size: 18px; color: white; font-weight: 400;">
